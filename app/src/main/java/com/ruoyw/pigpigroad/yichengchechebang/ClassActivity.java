...
import com.ruoyw.pigpigroad.yichengchechebang.fragment.Oilpage;
import com.ruoyw.pigpigroad.yichengchechebang.fragment.Vippage;
...
public class ClassActivity extends AppCompatActivity {
    ...
    private ImageView classrecord_btn, oilgun_btn;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        oilgun_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ClassActivity.this, OilStatisticsSituationActivity.class);
                startActivity(intent);
            }
        });
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.i("pppppppppp", "gmt timestamp: " + gmtTime);
                } catch (Exception e) {
                    Log.e("ppppppppp", "get time from network error: " + e);
                    return;
                }
                ...
                while (true) {
                    if (i >= TIMEOUT) {
                        Log.w("pppppppppppp", "location timeout");
                        break;
                    }
                    location = LocationService.getLocation();
                    if (location != null) {
                        Log.i("pppppppppppp", "location succeed i=" + i);
                        break;
                    }
                    try {
                        Thread.sleep(1000);
                    } catch (Exception e) {
                        Log.e("ppppppppppppp", "location InterruptedException");
                    }
                    i++;
                }
                int timeZoneInt;
                ...
                if (location != null) {
                    ...
                    Log.i("pppppppppppppp", "provider=" + location.getProvider() + ",longitude=" + longitude
                            + ",location zone=" + timeZoneInt + ",device zone=" + deviceZone);
                } else {
                    Log.w("pppppppppppp", "location failed, use device timezone");
                ...
                Log.i("ppppppppppppppp", "timeReal=" + timeReal + ",timeBeijing=" + timeBeijing + ",timeDevice=" + timeDevice);
                stopService(service);
